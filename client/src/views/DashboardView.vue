...
const publicModules = [
  { title: '?????', description: '?????????????????', to: '/evidence/matches' },
  { title: '?????', description: '?????????????????', to: '/evidence/odds' },
  { title: '???????', description: '????????????????', to: '/evidence/sentiment' },
  { title: '?????', description: '????????????????', to: '/decisions' },
  { title: '?????', description: '??????????????????????', to: '/workbench' },
  { title: '????', description: '??????????????', to: '/evidence/teams' },
  { title: '????', description: '???????????????', to: '/evidence/players' },
  { title: '????', description: '????????????', to: '/more' },
];

const adminModules = [
  { title: 'JSON ????', description: '???????? JSON ????', to: '/admin/import-review' },
];
